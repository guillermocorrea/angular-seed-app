...
module.exports = function (grunt) {
    ...
    grunt.registerTask('release2', ['clean','html2js','uglify','jshint','concat:index', 'recess:min','copy:assets']);
    ...
    grunt.initConfig({
        ...
        concat:{
            dist:{
                ...
                src:['<%= src.js %>', '<%= src.jsTpl %>', '!src/assets/**'],
        ...
        uglify: {
            ...
            bootstrap: {
                src:['assets/vendor/angular-ui/bootstrap/*.js'],
                dest: '<%= distdir %>/bootstrap.js'
            },
            jquery: {
        ...
        recess: {
            ...
            min: {
                files: {
                    ...
                    '<%= distdir %>/<%= pkg.name %>.css': ['src/assets/css/**/*.css']
                },
                options: {
                    compress: true
                }
        ...
        jshint:{
            ...
            //files:['gruntFile.js', 'app/**/*.js', 'common/**/*.js'],
            options:{
                curly:true,
                eqeqeq:true,
                immed:true,
